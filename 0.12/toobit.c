...
int main() {
  ...
  tb_set_physics_3ptr(&the_universe,&game_of_life_rules);	//set physics
  ...
  tb_server_start(&the_universe,8878);				//start the universe server
  ...
  while(1){				//----main loop
    ...
    tb_time_ticker_3ptr(&the_universe,31);
    usleep(60000);    
    }					//----end main loop
