...
#define TB_SPACE_SIZE_X 		300	// X resolution of space
#define TB_SPACE_SIZE_Y 		300
...
//------------Core Config---------------
//--------------------------------------
#define TB_THREADING_EXTRA_THREADS	0	//default core has 2 threads, this is how many more to add
...
#define TB_THREADING_TOTAL_THREADS			(TB_THREADING_EXTRA_THREADS		+	4				)
