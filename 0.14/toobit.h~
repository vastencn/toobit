...
#define TB_SPACE_SIZE_X 		400	// X resolution of space
...
//-----------Server Config--------------
//--------------------------------------
#define TB_SERVER_MAX_REQUEST_LEN		1000000	// maximum bytes of request to read per server connection
#define TB_SERVER_READ_RETRIES			200	// determines tolerance for crappy client connections
#define TB_SERVER_READ_WAIT_US			10	// us to wait before trying another read
...
#define TB_SERVER_COMMAND_GET_INJECT_BINARY	'I'	// request[5] character for binary injections
...
#define TB_SERVER_INJECTION_BUFFER_NUM_ENTRIES	10	// number of entries in injection buffer (entries are (x*y)+2 large)	  
...
#define TB_SERVER_INJECTION_BUFFER_ENTRY_SIZE		(TB_SPACE_SIZE_XY+2)
//--------------------------------------
//---------------FLAGS------------------
//--------------------------------------
